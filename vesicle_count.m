function table = vesicle_count (data)

% this function generates the summary table of the count data. 
...
for i = 1:length(data) 
    ...
    for j = 1:length(data(i).distance_data.vesicle)
        ...
        if data(i).distance_data.vesicle(j).dist2az <= 30
            ...
            if data(i).distance_data.vesicle(j).dist2az >30 ...
                &data(i).distance_data.vesicle(j).dist2pm <=30
    ...
    if isfield(data(i).distance_data, 'pits')
        ...
        for j = 1:length(data(i).distance_data.pits)
            ...
            if data(i).distance_data.pits(j).in_az == 1
                ...
                table(41,i+5) = table(41,i+5) + 1;
                
            elseif data(i).distance_data.pits(j).in_az == 0
                
                table(42,i+5) = table(42,i+5) + 1;
                
            end
        end
        
        table(43,i+5) = table(41,i+5) + table(42,i+5);
    ...
    if isfield(data(i).distance_data, 'coated_pits')
        ...
        for j = 1:length(data(i).distance_data.coated_pits)
            ...
            if data(i).distance_data.coated_pits(j).in_az == 1
                ...
                table(44,i+5) = table(44,i+5) + 1;
                
            elseif data(i).distance_data.coated_pits(j).in_az == 0
                
                table(45,i+5) = table(45,i+5) + 1;
                
            end
        end
        
        table(46,i+5) = table(44,i+5) + table(45,i+5);
    ...
    if isfield(data(i).distance_data, 'fpits')
        ...
        for j = 1:length(data(i).distance_data.fpits)
            ...
            if data(i).distance_data.fpits(j).in_az == 1
                ...
                table(47,i+5) = table(47,i+5) + 1;
                
            elseif data(i).distance_data.fpits(j).in_az == 0
                
                table(48,i+5) = table(48,i+5) + 1;
                
            end
        end
        
        table(49,i+5) = table(47,i+5) + table(48,i+5);
    ...
    if isfield(data(i).distance_data, 'coated_fpits')
        ...
        for j = 1:length(data(i).distance_data.coated_fpits)
            ...
            if data(i).distance_data.coated_fpits(j).in_az == 1
                ...
                table(50,i+5) = table(50,i+5) + 1;
                
            elseif data(i).distance_data.coated_fpits(j).in_az == 0
                
                table(51,i+5) = table(51,i+5) + 1;
                
            end
        end
        
        table(52,i+5) = table(50,i+5) + table(51,i+5);
...
for i = 1:length(data)
    ...
    if isfield(data(i).distance_data, 'buds')
        
        for j = 1:length(data(i).distance_data.buds)
                
            table(53,i+5) = table(53,i+5) + 1;
...
for i = 1:length(data)
    ...
    if isfield(data(i).distance_data, 'fbuds')
        
        for j = 1:length(data(i).distance_data.fbuds)
                
            table(54,i+5) = table(54,i+5) + 1;
