function distribution_data = distribution_pm (data, bin, vesicle_type)
        ...
        if isfield (data(i), 'distance_data')
            ...
            if isfield (data(i).distance_data, 'endosome')
                ...
                for j = 1:length(data(i).distance_data.endosome)
                    ...
                    if data(i).distance_data.endosome(j).dist2pm == 0
                        
                        distribution_data(1,i+6) = distribution_data(1,i+6) +1;
                        
                    elseif data(i).distance_data.endosome(j).dist2pm > a*bin
                        ...
                        for k = 1:a
                            ...
                            if (bin*k - bin) < data(i).distance_data.endosome(j).dist2pm...
                                    & data(i).distance_data.endosome(j).dist2pm <= bin*k
        ...
        if isfield (data(i), 'distance_data')
            ...
            if isfield (data(i).distance_data, 'fendosome')
                ...
                for j = 1:length(data(i).distance_data.fendosome)
                    ...
                    if data(i).distance_data.fendosome(j).dist2pm == 0
                        
                        distribution_data(1,i+6) = distribution_data(1,i+6) +1;
                        
                    elseif data(i).distance_data.fendosome(j).dist2pm > a*bin
                        ...
                        for k = 1:a
                            ...
                            if (bin*k - bin) < data(i).distance_data.fendosome(j).dist2pm...
                                    & data(i).distance_data.fendosome(j).dist2pm <= bin*k
        ...
        if isfield (data(i), 'distance_data')
            ...
            if isfield (data(i).distance_data, 'mvb')
                ...
                for j = 1:length(data(i).distance_data.mvb)
                    ...
                    if data(i).distance_data.mvb(j).dist2pm == 0
                        
                        distribution_data(1,i+6) = distribution_data(1,i+6) +1;
                        
                    elseif data(i).distance_data.mvb(j).dist2pm > a*bin
                        ...
                        for k = 1:a
                            ...
                            if (bin*k - bin) < data(i).distance_data.mvb(j).dist2pm...
                                    & data(i).distance_data.mvb(j).dist2pm <= bin*k
        ...
        if isfield (data(i), 'distance_data')
            ...
            if isfield (data(i).distance_data, 'fmvb')
                ...
                for j = 1:length(data(i).distance_data.fmvb)
                    ...
                    if data(i).distance_data.fmvb(j).dist2pm == 0
                        
                        distribution_data(1,i+6) = distribution_data(1,i+6) +1;
                        
                    elseif data(i).distance_data.fmvb(j).dist2pm > a*bin
                        ...
                        for k = 1:a
                            ...
                            if (bin*k - bin) < data(i).distance_data.fmvb(j).dist2pm...
                                    & data(i).distance_data.fmvb(j).dist2pm <= bin*k
            ...
            if isfield (data(i).distance_data, 'vesicle')
                ...
                for j = 1:length(data(i).distance_data.vesicle)
                    ...
                    if strcmp(data(i).distance_data.vesicle(j).type, vesicle_type)
                        ...
                        if data(i).distance_data.vesicle(j).dist2pm == 0
                            
                            distribution_data(1,i+6) = distribution_data(1,i+6) +1;
                            
                        elseif data(i).distance_data.vesicle(j).dist2pm > a*bin
                            ...
                            for k = 1:a
                                ...
                                if (bin*k - bin) < data(i).distance_data.vesicle(j).dist2pm...
                                        & data(i).distance_data.vesicle(j).dist2pm <= bin*k
