function distribution_data = distribution_pm_all_SV (vesicle_distribution_pm)
...
[a,b] = size(vesicle_distribution_pm.docked_SV);

distribution_data = zeros(a,b);

for i = 1:a
    
    distribution_data (i,1) = vesicle_distribution_pm.docked_SV(i,1);
...
for i = 1:a
    ...
    for j = 7:b
        ...
        distribution_data (i,j) = vesicle_distribution_pm.docked_SV(i,j)...
                                + vesicle_distribution_pm.tethered_SV(i,j)...
                                + vesicle_distribution_pm.cytosolic_SV(i,j);
