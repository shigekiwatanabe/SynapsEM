function table = vesicle_count_sr (data)
...
for i = 1:length(data) 
    ...
    if isfield(data(i).analysis_data,'sr') && isfield(data(i).distance_data, 'vesicle')
    
    table (1,i+5) = data(i).analysis_data.sr.length;
    
    for j = 1:length(data(i).distance_data.vesicle)
            
        vesicle_type = data(i).distance_data.vesicle(j).type;
        
        if data(i).distance_data.vesicle(j).dist2sr <= 100
...
for i = 1:length(data)
    ...
    if isfield(data(i).analysis_data,'sr') && isfield(data(i).distance_data, 'endosome')
        
        for j = 1:length(data(i).distance_data.endosome)
        
            if data(i).distance_data.endosome(j).dist2sr <= 100
...
for i = 1:length(data)
    ...
    if isfield(data(i).analysis_data,'sr') && isfield(data(i).distance_data, 'fendosome')
        
        for j = 1:length(data(i).distance_data.fendosome)
        
            if data(i).distance_data.fendosome(j).dist2sr <= 100
...
for i = 1:length(data)
    ...
    if isfield(data(i).analysis_data,'sr') && isfield(data(i).distance_data, 'mvb')
        
        for j = 1:length(data(i).distance_data.mvb)
        
            if data(i).distance_data.mvb(j).dist2sr <= 100
...
for i = 1:length(data)
    ...
    if isfield(data(i).analysis_data,'sr') && isfield(data(i).distance_data, 'fmvb')
        
        for j = 1:length(data(i).distance_data.fmvb)
        
            if data(i).distance_data.fmvb(j).dist2sr <= 100
